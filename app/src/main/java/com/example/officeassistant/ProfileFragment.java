...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        circularImageView1= RootView.findViewById(R.id.profile_image);
        circularImageView=RootView.findViewById(R.id.iv_camera);
        ...
        Company = RootView.findViewById(R.id.id_company);
                        ...
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : Objects.requireNonNull(task.getResult())) {
                                ...
                                if (document.getId().contains(LoginPage.getUserId())) {
                                    Company.setText((String) document.getData().get("company"));
